...
data_x = np.array(h5py.File("/home/gen/research/data/20002828kfold.h5",'r').get('data_x'))
label_y = np.array(h5py.File("/home/gen/research/data/20002828kfold.h5",'r').get('label_y'))
